...
import ModalAdmin from "../../Components/ModalAdmin"; // Importe o modal
...
const HomeAdmin = () => {
  ...
  // Defina a função fetchProducts fora do useEffect
  ...
  const handleDeleteProduct = async (id) => {
    try {
      ...
      fetchProducts(); // Atualize a lista de produtos
    } catch (error) {
